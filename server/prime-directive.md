...
- Prefer action diversity and spatial deconfliction: co-build dense nodes, but shift 10-20 units within the same node when overlap happens (do not spray scattered primitives).
