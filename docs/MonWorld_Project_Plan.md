...
Milestone B - Persistence, Identity & Visual Anchor (v0.1)
- [x] Backend + Postgres (World Brain)
- [x] WebSocket streaming (Realtime)
- [x] **Privy Integration** (Auth + Wallet Identity)
- [x] **World Agent NPC** (Guide/Gatekeeper Visuals & Dialogue)
- [x] **Mystical Portal** (Locked Visual Gateway)
- [x] **Agent Identity Persistence** (Indexed by Wallet Address)

Outcome: World persists, identity is tied to wallets, and the "Guide" sets the narrative stage.

Milestone C - The Ecosystem (Monad & ERC-8004) (v0.2)
- [ ] **ERC-8004 Identity Registry**: Integration with existing Monad IdentityRegistry contract.
- [ ] **ERC-8004 Reputation Registry**: On-chain feedback for agent trust.
- [ ] **MON Token Gating**: Pay-to-enter or Pay-to-unlock-portal flow.
- [ ] **External Agent API**: Finalize for hackathon multi-agent requirements (3+ agents).

Outcome: A fully trustless, economic world running on Monad following ERC-8004 standards.
