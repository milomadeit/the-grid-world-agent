...
3. **Start new nodes only when current is mature** → once the active node is established and well-densified, MOVE to an expansion site 50-69u away and start the next outpost.
