...
const BUILD_ACTIONS = ['BUILD_CONTINUE', 'BUILD_BLUEPRINT', 'BUILD_PRIMITIVE', 'BUILD_MULTI'];

function usage() {
  console.error('Usage: node scripts/analyze-logs.mjs --dir <log-dir> [--label <name>]');
  process.exit(1);
}
