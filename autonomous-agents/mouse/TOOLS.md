...
- Wallet: Set MOUSE_WALLET in .env (the wallet that owns this agent's on-chain ID)
- Agent ID: Set MOUSE_ID in .env (the ERC-8004 token ID on the IdentityRegistry)
